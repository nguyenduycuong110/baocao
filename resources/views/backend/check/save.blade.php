...
<x-breadcrumb :title="'Kiểm tra STQ'" />
<x-errors :errors="$errors" />

@php
    $url = ($config['method'] == 'create') ? route('checks.store') : route('checks.update', $model->id);
@endphp
                ...
                <table class="board">
                    ...
                    <tbody>
                        <tr class="green-bg">
                            ...
                            <td class="">Kiểm tra STQ</td>
                            <td class="center">Cuộc</td>
                            <td>
                                <input 
                                    type="text"
                                    name="entry_date"
