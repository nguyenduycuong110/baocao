                ...
                <table class="board">
                    ...
                    <tbody>
                        @php
                            ...
                            $total_exit_month = $accumulated['accumulatedMonth']->total_car_exit + $accumulated['accumulatedMonth']->total_boats_exit;
                            $total_exit_year = $accumulated['accumulatedYear']->total_car_exit + $accumulated['accumulatedYear']->total_boats_exit;
                            $total_entry_month = $accumulated['accumulatedMonth']->total_car_entry + $accumulated['accumulatedMonth']->total_boats_entry;
                            $total_entry_year = $accumulated['accumulatedYear']->total_car_entry + $accumulated['accumulatedYear']->total_boats_entry;
                        @endphp
                        <tr class="green-bg">
